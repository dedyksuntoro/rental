...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tbl_kantor SET nama_kantor = '$nama_kantor', alamat_kantor = '$alamat_kantor'
            WHERE id = $id";
...
if (isset($_POST['edit'])) {
    $id = $_POST['edit'];
    $sql_edit = "SELECT * FROM tbl_kantor WHERE id = $id";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama-kantor-column" class="form-control" placeholder="Masukkan nama kantor" name="nama_kantor" data-parsley-required="true" value="<?php echo $row['nama_kantor'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="alamat-kantor-column">Alamat Kantor</label>
                                                    <input type="text" id="alamat-kantor-column" class="form-control" placeholder="Masukkan alamat kantor" name="alamat_kantor" data-parsley-required="true" value="<?php echo $row['alamat_kantor'] ?>">
                                                </div>
                                            </div>
