...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tbl_order_vendor SET nama_vendor = '$nama_vendor'
            WHERE id = $id";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header('Location: vendor.php?vendor=active');
    } else {
...
if (isset($_POST['edit'])) {
    $id = $_POST['edit'];
    $sql_edit = "SELECT * FROM tbl_order_vendor WHERE id = $id";
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama-vendor-column" class="form-control" placeholder="Masukkan nama vendor" name="nama_vendor" data-parsley-required="true" value="<?php echo $row['nama_vendor'] ?>">
                                                </div>
                                            </div>
